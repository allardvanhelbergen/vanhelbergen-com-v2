...
get_header(); ?>
		...
		<section id="primary" class="eight columns">
			...
			<?php if ( have_posts() ) : ?>
				...
				<?php
				// If a user has filled out their description, show a bio on their 
				// entries.
			...
			<?php else : ?>
				...
				<article id="post-0" class="post no-results not-found">
					...
					<div class="entry-content">
						<p><?php 
							_e( 'Apologies, but no results were found for the requested ' .
											'archive. Perhaps searching will help find a related ' .
											'post.', 
									'twentyeleven' ); ?>
						</p>
					</div><!-- .entry-content -->
